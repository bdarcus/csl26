...
2. **LLM-author templates for top 5-10 parent styles** - Using `/styleauthor` skill or `@styleauthor` agent. Validated with APA 7th (5/5 citation + bibliography). Covers 60% of dependent styles with highest confidence. See bean csl26-o3ek.
...
**Estimated effort:** ~1,500 lines new code. LLM-authored templates replace manual domain-expert time.