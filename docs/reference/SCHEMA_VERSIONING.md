...
The root changelog is workspace-wide. It is generated by `git-cliff` via the
`cargo-release` pre-release hook, so the release PR reflects the full release.

## Automated Release Flow

### Release PRs

Code and schema releases are prepared by `.github/workflows/release.yml`.

1. When a release-impacting commit merges to `main`, the workflow inspects the
   commit range since the latest `v*` tag.
...
| `feat:` | Minor |
| `fix:` / `perf:` | Patch |
| `feat!:` / `fix!:` / `perf!:` or `BREAKING CHANGE:` | Major, capped to minor before 1.0 |
...
Schema tags continue to use the `schema-vX.Y.Z` prefix and are created by the
release workflow when a release PR includes a schema version bump.
...
#### schema-v0.77.0 (2026-09-06)
- Schema version bumped from 0.76.0 to 0.77.0

#### schema-v0.76.0 (2026-08-13)
- Schema version bumped from 0.75.0 to 0.76.0

#### schema-v0.75.0 (2026-08-02)
- Schema version bumped from 0.74.0 to 0.75.0

#### schema-v0.74.0 (2026-07-24)
- Schema version bumped from 0.73.0 to 0.74.0

#### schema-v0.73.0 (2026-07-21)
- Schema version bumped from 0.72.0 to 0.73.0

#### schema-v0.72.0 (2026-07-15)
- Schema version bumped from 0.71.0 to 0.72.0
...
#### schema-v0.69.0 (2026-07-07)
- Schema version bumped from 0.68.0 to 0.69.0

#### schema-v0.68.0 (2026-07-05)
- Schema version bumped from 0.67.0 to 0.68.0

#### schema-v0.67.0 (2026-06-28)
- Schema version bumped from 0.66.0 to 0.67.0

#### schema-v0.66.0 (2026-06-21)
- Schema version bumped from 0.65.0 to 0.66.0

#### schema-v0.65.0 (2026-06-18)
- Schema version bumped from 0.64.0 to 0.65.0

#### schema-v0.64.0 (2026-06-12)
- Schema version bumped from 0.63.0 to 0.64.0

#### schema-v0.63.0 (2026-06-09)
- Schema version bumped from 0.62.0 to 0.63.0

#### schema-v0.62.0 (2026-06-08)
- Schema version bumped from 0.61.0 to 0.62.0

#### schema-v0.61.0 (2026-06-07)
- Schema version bumped from 0.60.0 to 0.61.0

#### schema-v0.60.0 (2026-06-04)
- Schema version bumped from 0.59.0 to 0.60.0

#### schema-v0.59.0 (2026-06-02)
- Schema version bumped from 0.58.0 to 0.59.0

#### schema-v0.58.0 (2026-05-27)
- Schema version bumped from 0.57.0 to 0.58.0

#### schema-v0.57.0 (2026-05-25)
- Schema version bumped from 0.56.0 to 0.57.0

#### schema-v0.56.0 (2026-05-24)
- Schema version bumped from 0.55.0 to 0.56.0

#### schema-v0.55.0 (2026-05-18)
- Schema version bumped from 0.54.0 to 0.55.0

#### schema-v0.54.0 (2026-05-16)
- Schema version bumped from 0.53.0 to 0.54.0

#### schema-v0.53.0 (2026-05-16)
- Schema version bumped from 0.52.0 to 0.53.0

#### schema-v0.52.0 (2026-05-16)
- Schema version bumped from 0.51.0 to 0.52.0

#### schema-v0.51.0 (2026-05-15)
- Schema version bumped from 0.50.0 to 0.51.0

#### schema-v0.50.0 (2026-05-14)
- Schema version bumped from 0.49.0 to 0.50.0

#### schema-v0.49.0 (2026-05-14)
- Schema version bumped from 0.48.0 to 0.49.0

#### schema-v0.48.0 (2026-05-13)
- Schema version bumped from 0.47.0 to 0.48.0

#### schema-v0.47.0 (2026-05-13)
- Schema version bumped from 0.46.2 to 0.47.0

#### schema-v0.46.2 (2026-05-12)
- Schema version bumped from 0.46.1 to 0.46.2

#### schema-v0.46.1 (2026-05-12)
- Schema version bumped from 0.46.0 to 0.46.1

#### schema-v0.46.0 (2026-05-11)
- Schema version bumped from 0.45.0 to 0.46.0

#### schema-v0.45.0 (2026-05-11)
- Schema version bumped from 0.44.0 to 0.45.0

#### schema-v0.44.0 (2026-05-06)
- Schema version bumped from 0.43.0 to 0.44.0

#### schema-v0.43.0 (2026-05-06)
- Schema version bumped from 0.42.0 to 0.43.0
...
- Note: pre-1.0 schema major bumps increment minor, not major
